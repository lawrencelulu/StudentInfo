...
public class CoursePlanServiceImpl implements CoursePlanService {
    ...
    public int updateCoursePlanComment(String courseclass) {
        return coursePlanMapper.updateCoursePlanComment(courseclass);
    }
    /**
     *  根据排课班级名删除课程信息信息
     ...
     */
    @Override
    public List<CoursePlan> getCoursePlanList(int pageNo, int pageSize) {
        Map<String,Object> data = new HashMap<String,Object>();
        data.put("pageNo",(pageNo-1) * pageSize);
        data.put("pageSize",pageSize);
        return coursePlanMapper.getCoursePlanList(data);
    }
    ...
    public List<CoursePlan> getCidByCoursePlanTid(int pageNo, int pageSize, String tid) {
        ...
        data.put("pageSize",pageSize);
        data.put("tid",tid);
        return coursePlanMapper.getCoursePlanByCourseClass(data);
    }
     ...
     */
    @Override
    public List<CoursePlan> getTidByCoursePlanCid(int pageNo, int pageSize, String courseclass) {
        Map<String,Object> data = new HashMap<String,Object>();
        data.put("pageNo",(pageNo-1) * pageSize);
        data.put("pageSize",pageSize);
        data.put("courseclass",courseclass);
