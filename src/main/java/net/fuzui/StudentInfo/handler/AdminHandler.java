...
// 		student.setClassr(arr_belongcla[pro][col][cla]);
	...
	public String manageCou(Model model, HttpSession httpSession, @PathVariable(value = "pn") String pn) {
		...
		couList = courseService.selectCourseBySql(1, 10);
		httpSession.setAttribute("couList", couList);
//		for (CoursePlan cp : coursePlanList) {
//			for (Course c : couList) {
//				if (cp.getCid() == c.getCid()) {
//					System.out.println(c);
//					break;
//				}
//			}
//		}
		return "admin/courseplan";
	}
...
// 			System.out.println(studentList);
 	...
 	public String adCourse(HttpServletRequest request) {
		List<Course> couList = new ArrayList<Course>();
		couList = courseService.selectCourseBySql(1, 10);
