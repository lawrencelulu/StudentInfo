...
public interface SelectCourseMapper {
     ...
     * @return  选课结果
     */
    public int selectCourse(@Param("courseclass") String courseclass, @Param("cid") String cid, @Param("sid") String sid);

    /**
     * 判断是否加入过此课程
     * @param courseclass   教学班编号
     * @param sid   学号
     * @return
     */
    public String existCourse(@Param("courseclass") String courseclass, @Param("sid") String sid);
     ...
     * @return
     */
    public String existPreCourse(@Param("cid") String cid, @Param("sid") String sid);
    ...
    public int updateSCByCidSid(Map<String, Object> data);

    public int updateSCByCourseclassSid(Map<String, Object> data);
     ...
     * @return
     */
    public int deleteSC(@Param("courseclass") String courseclass,@Param("sid") String sid);
