...
<%--										<td>${exit.totalNum }</td>--%>
										<td>${exit.stuSum }</td>
										<td><a class="btn btn-primary" href="/StudentInfo/TeacherHandler/looksel/${exit.cid }/${exit.cname}/1">
												查看名单 </a></td>
										<td><a class="btn btn-primary" href="/StudentInfo/TeacherHandler/endcou/${exit.cid }/${exit.cname}/1">
												结课 </a></td>
