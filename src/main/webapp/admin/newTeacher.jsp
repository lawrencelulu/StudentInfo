    ...
    <div class="content-wrapper" style="padding-top: 20px;">
        ...
        <section class="content col-md-8" style="margin: 0 auto;">
            <div class="card">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="/StudentInfo/AdminHandler/addTeacher" method="post" name="form1">
                    <div class="card-body">
                        <div class="form-group">
                            <label for="tid">教师编号</label>
                            <input type="text" name="tid" id="tid" class="form-control" maxlength="5"></input>
                            <span id="counttid" style="color: #ff0000;"></span>
                        </div>
                        <div class="form-group">
                            <label>姓名</label>
                            <input type="text" name="tname" class="form-control" maxlength="4"></input>
                        </div>
                        ...
                        <div class="form-group">
                            <label>密码</label>
                            <input type="password" name="tpassword" class="form-control" onkeyup="this.value=this.value.replace(/(^\s+)|(\s+$)/g,'');" maxlength="16"/>
                        </div>
                        <div class="form-group">
                            <label>联系方式 - 手机号</label>
                            <input type="number" name="tphone" class="form-control" maxlength="11"></input>
                        </div>
                        <div class="form-group">
                            <label>生日</label>
                            <input type="text" name="tbirthday" class="form-control"></input>
                        </div>
                    </div>
                    <!-- /.card-body -->
