		...
		<div class="row">
			...
			<c:forEach var="teacher" items="${requestScope.teacherList}">
					...
					<form action="../modityTeac/${teacher.tid}" method="get">
							...
							<h6>手机号</h6>
							<input type="text" name="tphone" value="${teacher.tphone }" class="form-control"></input>
							<h6>职称</h6>
							<input type="text" name="tlevel" value="${teacher.tlevel }" class="form-control"></input>
							<h6>生日</h6>
							<input type="text" name="tbirthday" value="${teacher.tbirthday }" class="form-control"></input>
							<h6>密&nbsp;&nbsp;码</h6>
